...
func builtinRules() []Rule {
	return []Rule{
		// --- File system rules ---
		{
			...
			Match:   RuleMatch{Tool: stringOrList{"exec", "read"}, ArgContains: stringOrList{".ssh/id_"}},
			Action:  "block",
		...
		},
		{
			...
			Match:   RuleMatch{Tool: stringOrList{"write", "exec"}, ArgContains: stringOrList{"PRIVATE KEY-----"}},
			Action:  "block",
		...
		},
		{
			...
			Match:   RuleMatch{Tool: stringOrList{"write", "edit"}, ArgContains: stringOrList{".ctrlai/"}},
			Action:  "block",
